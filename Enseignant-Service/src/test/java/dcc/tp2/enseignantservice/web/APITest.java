...
@WebMvcTest(API.class)   //demarer tout lier a couche web
class APITest {

    // MOCK: charge f local
    //Mockbean charge f context d app
    @MockBean
    private EnseignantService enseignantService;

    //possibiliter (simuler) d envoyer des req http
    @Autowired
    private MockMvc mockMvc;

    @Autowired    //convertit l json
    ...
    void add() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/Enseignants").contentType(MediaType.APPLICATION_JSON_VALUE).content(objectMapper.writeValueAsString(enseignant)))
    ...
    void update() throws Exception {
        Long id = 1L;
        Enseignant enseignant_modifiy =  new Enseignant(1L, "douae", "chmihi-md", "p3213", "douae@gmail.com", "123", "info", "Enseignant");
